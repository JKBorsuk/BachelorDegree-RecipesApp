                ...
                <div className="recipe-container">
                    <div className="recipe">
                        ...
                        <div className="recipe-child recipe-spices"><hr/>
                            {(typeof(this.state.ingredient.spices) == "object") ?
                            <div>
                                <p>Dodatki</p>
                                <div>
                        ...
                        <div className="recipe-child recipe-image"><img id='rec-image' style={{maxWidth: this.state.max_width, width: '100%', height: 'auto', aspectRatio: '2', objectFit: 'cover'}} src={typeof(this.state.ingredient.photoFileName) == 'string' ? "images/" + this.state.ingredient.photoFileName : ""}/></div>
